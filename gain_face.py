...
path_photos_from_camera = "./datas/1/"
...
def pre_work_del_old_face_folders():
    ...
    if os.path.isfile("datas/features_all.csv"):
        os.remove("datas/features_all.csv")
...
if os.listdir("datas/1/"):
    # 获取已录入的最后一个人脸序号
    person_list = os.listdir("datas/1/")
    person_list.sort()
